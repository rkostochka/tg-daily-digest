...
5. По каждому пункту: краткая суть (1–2 предложения) + одна строка с эмодзи ⚡ — что это меняет или на что влияет.
6. Ссылки: если есть прямая ссылка на пост или внешняя — в конце пункта [источник](url). Не более 1 ссылки на пункт.
...
*Главное за день*
• <короткая фраза о ключевом событии>
• <ещё одна>
• <всего 3–6 пунктов, по одной строке>
...
⚡ _<Что это меняет / последствия в одном предложении.>_

▸ *<Следующий пункт>.* <Суть.> [источник](url)
⚡ _<Влияние.>_
